...
ds_email			varchar(200) not null,
ds_senha			varchar(200) not null,
ds_codigo			varchar(200) not null
);
...
foreign key (id_imagens_produto) references tb_imagens_produto (id_imagens_produto)
);
...
id_imagens_produto		int not null,
id_estoque				int not null,
cd_sku					varchar(200) not null,
...
vl_profundidade			decimal(10,2) not null,
vl_volume				decimal(10,2) not null,
ds_cod					varchar(200) not null,
